...
public:
	...
	void setTrajectoryGroup(std::shared_ptr<ArmMotionProfile> group) override;
...
private:
	double getPointValue(const Pose2dTrajectory& pt, const QString& node);
